  ...
  return (
    <section className="grid gap-3">
      ...
      <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-3">
        {boards.length ? (
          boards.map(({ board }) => (
            <Link key={board.id} href={`/app/boards/${board.id}`} className="drawi-panel block p-4">
              <div className="mb-3 aspect-[4/3] rounded-lg border border-[var(--line-subtle)] bg-white" />
